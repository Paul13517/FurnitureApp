...
public class SafeArea : MonoBehaviour
{
    ...
    /// </summary>
    private const SimDevice Sim = SimDevice.None;
    ...
    public UnityEventInt OnSafeAreaChanged;
    ...
    private void Refresh()
    {
        ...
        if (safeArea == _lastSafeArea && Screen.width == _lastScreenSize.x && Screen.height == _lastScreenSize.y && Screen.orientation == _lastOrientation) return;
    ...
    {
        var statusBarHeight = NativeAndroid.GetStatusBarHeight();
        var area = Screen.safeArea;
        if(Application.platform is RuntimePlatform.Android)
            area.height = Screen.height - statusBarHeight;
        OnSafeAreaChanged?.Invoke(statusBarHeight);
        return area;
        ...
        // switch (Sim)
        // {
        //     case SimDevice.PhoneX:
        //         nsa = Screen.height > Screen.width ? _nsaIPhoneX[0] : _nsaIPhoneX[1];
        //         break;
        //     case SimDevice.PhoneXsMax:
        //         nsa = Screen.height > Screen.width ? _nsaIPhoneXsMax[0] : _nsaIPhoneXsMax[1];
        //         break;
        //     case SimDevice.Pixel3XlLsl:
        //         nsa = Screen.height > Screen.width ? _nsaPixel3XlLsl[0] : _nsaPixel3XlLsl[1];
        //         break;
        //     case SimDevice.Pixel3XlLsr:
        //         nsa = Screen.height > Screen.width ? _nsaPixel3XlLsr[0] : _nsaPixel3XlLsr[1];
        //         break;
        // }
        //
