...
namespace Generated
{
    public class Project3DViewWindowBinding
    {
        ...
        public Project3DViewWindowBinding(GameObject gameObject) => GameObject = gameObject;
        ...
        public BackIconBinding BackIcon => _backIcon ??= new BackIconBinding(GameObject.transform.Find("BackIcon").gameObject);
    }
}
